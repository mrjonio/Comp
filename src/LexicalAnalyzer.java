 ...
 * from the specification file <tt>C:/Users/carlo/Documents/Antônio-Adelino_Carlos-Antônio/Comp/src/language.lex</tt>
 */
...
private void imprimir(String descricao, String lexema) {
   ...
   * @exception   java.io.IOException  if any I/O-Error occurs
   */
  public TokenPascal yylex() throws java.io.IOException {
    int zzInput;
    int zzAction;
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 8: break;
          case 2: 
            { imprimir("Espa�o em branco", yytext());
            } 
            // fall through
          case 9: break;
          case 3: 
          ...
          case 10: break;
          case 4: 
            { imprimir("N�mero Inteiro", yytext());
            } 
            // fall through
          case 11: break;
          case 5: 
